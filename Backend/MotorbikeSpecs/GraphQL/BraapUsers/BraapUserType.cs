...
namespace MotorbikeSpecs.GraphQL.BraapUsers
{
    public class BraapUserType: ObjectType<BraapUser>
    {
        protected override void Configure(IObjectTypeDescriptor<BraapUser> descriptor)
        {
            ...
            descriptor
                .Field(s => s.Reviews)
                .ResolveWith<Resolvers>(r => r.GetReviewsByBraapUser(default!, default!, default))
        ...
        {
            public async Task<IEnumerable<Review>> GetReviewsByBraapUser(BraapUser braapuser, [ScopedService] BraapDbContext context,
